...
export default function Breadcrumb({ items, search, onSearch, placeholder = "Search...", year, onYearChange }) {
    return (
        <nav className="breadcrumbs-wrapper">
            <ul className="breadcrumbs">
                ...
                <li className="breadcrumbs-controls">
                    {onYearChange && (
                        <SelectYear value={year} change={(e) => onYearChange(e.target.value)} />
                    )}
                    {onSearch && (
